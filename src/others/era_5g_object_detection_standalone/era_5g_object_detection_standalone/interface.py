...
#from worker_face import FaceDetectorWorker
from worker_mmdet import MMDetectorWorker
from era_5g_object_detection_common import InitializationFailed
...
def main(args=None):
    ...
    # Create detector
    try:
        detector_thread = MMDetectorWorker(logger, "Detector", image_queue, app)
